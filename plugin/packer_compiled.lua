...
_G.packer_plugins = {
  ...
  ["FTerm.nvim"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/FTerm.nvim",
  ...
  ["denops.vim"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/denops.vim",
    url = "https://github.com/vim-denops/denops.vim"
  },
  firenvim = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/firenvim",
  ...
  ["nvim-treesitter-refactor"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/nvim-treesitter-refactor",
  ...
  ["vim-brainfuck"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/vim-brainfuck",
  ...
  ["vim-gutentags"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/vim-gutentags",
    url = "https://github.com/ludovicchabant/vim-gutentags"
  },
  ["vim-rhubarb"] = {
    loaded = true,
    path = "/Users/mac/.local/share/nvim/site/pack/packer/start/vim-rhubarb",
